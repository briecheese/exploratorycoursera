...
par(mfrow=c(2,2))
# top left
plot(power_consumption$Time,power_consumption$Global_active_power,type="l",ylab="Global Active Power",xlab="")
# top right
plot(power_consumption$Time,power_consumption$Voltage,type="l",ylab="Voltage",xlab="datetime")
# bottom left
...
# bottom right
plot(power_consumption$Time,power_consumption$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime")
dev.off()